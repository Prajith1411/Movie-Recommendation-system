...
1. Clone the repository:
    ```bash
    git clone https://github.com/Prajith1411/Movie-Recommendation-system.git
...
![App on Launch](./image%20copy.png)
...
![Movie Selection](./image%20copy%202.png)
